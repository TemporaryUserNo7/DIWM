...
parser.add_argument('--dataset', type=str, default='cifar10', choices=['mnist', 'cifar100', 'svhn', 'cifar10', 'caltech101', 'nyuv2'],
...
train_loader_p,test_loader_p=get_dataloader(args)
...
generator.load_state_dict(torch.load("./checkpoint/student/cifar10-resnet18_8x-generator.pt"))
generator.eval()
...
if test_branch==3:
    #1,2 2000
    #3 300
    DFD(model,generator,500,I_loader,I,True)
if test_branch==4:
